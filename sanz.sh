...
# REPO    
    ...
    wget https://raw.githubusercontent.com/sanzVPN/Azerd/ABSTRAK/files/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh
####
start=$(date +%s)
secs_to_human() {
...
function menu_noobz() {
wget https://raw.githubusercontent.com/sanzVPN/Azerd/ABSTRAK/files/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
